// src/app/api/subpoenas/[subpoenaId]/pdf/route.ts
...
import { buildSubpoenaPdf } from "@/server/services/subpoenas/build";
...
export async function GET(
  ...
  const buf = await buildSubpoenaPdf({ subpoenaId });
  const filename = `subpoena-${row.subpoenaNumber}.pdf`;
