// src/app/api/jury-instruction-sets/[setId]/pdf/route.ts
...
import { buildJuryInstructionsPdf } from "@/server/services/jury-instructions/build";
...
export async function GET(
  ...
  const buf = await buildJuryInstructionsPdf({ setId });
